      ...
      <div className="mt-6 space-y-4 text-sm leading-relaxed text-zinc-300">
        <div>
          ...
          <p className="mt-2 text-sm text-zinc-400">
            You must own or have a valid license for every photo, artwork file, and reference image you upload or link
            for a listing. You are solely responsible for proving you have those rights.
          </p>
        </div>
